    ...
    <div>
      ...
      <div class="video-controls" data-videoid="newEntry">
        <button class="play" aria-hidden="false">
          <img loading="lazy" src="/assets/images/ios/play.png" srcset="/assets/images/ios/play@2x.png 2x, /assets/images/ios/play@3x.png 3x" width="15" height="15"/> 
          <span>Play</span>
        </button>
        <button class="pause" aria-hidden="true">
          <img loading="lazy" src="/assets/images/ios/pause.png" srcset="/assets/images/ios/pause@2x.png 2x, /assets/images/ios/pause@3x.png 3x" width="15" height="15"/> 
          <span>Pause</span>
        </button>
        <button class="replay" aria-hidden="true">
          <img loading="lazy" src="/assets/images/ios/replay.png" srcset="/assets/images/ios/replay@2x.png 2x, /assets/images/ios/replay@3x.png 3x" width="15" height="15"/> 
          <span>Replay</span>
        </button>
      </div> <!-- Video controls -->
    </div> <!--Video container -->
          ...
          <div>
            <div class="card-item-content shadowed interactive">
              ...
              <picture>
                ...
                <img loading="lazy" src="/assets/images/ios/recurring.png" srcset="/assets/images/ios/recurring@2x.png 2x, /assets/images/ios/recurring@3x.png 3x" width="394" height="576" alt="Recurring detail view showing the title of the item (Gamepass), the associated amount, upcoming date, and list of past entries generated for it." loading="lazy"/>
              </picture>
            </div>
          </div>
        </li>
