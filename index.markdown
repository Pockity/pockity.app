...
<div class="container readable center">
  <h2 class="section-header-xxl vault">Form a Habit</h2>
  <p>Pockity is a personal budgeting app that takes advantage of forming a habit around doing something repeatedly. Set up budgets, enter expenses, and track budgets across categories. Pockity neatly presents information to you and lets you act on it.</p>
</div>
...
<div class="container" id="home-widgets">
  <div class="grid">
    <hgroup>
    <h3 class="vault">Widgets</h3>
